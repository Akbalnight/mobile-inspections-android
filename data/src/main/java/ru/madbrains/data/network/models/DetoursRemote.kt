...
data class DetoursRemote(
    ...
    @field:Json(name = "dateStartPlan") val dateStartPlan: Date?,
    @field:Json(name = "dateFinishPlan") val dateFinishPlan: Date?,
    @field:Json(name = "dateStartFact") val dateStartFact: Date?,
    @field:Json(name = "dateFinishFact") val dateFinishFact: Date?,
